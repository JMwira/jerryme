    ...
    <div id="skills" className='bg-primary py-10' >
        <div className='w-[80%] px-10 grid-cols-1 grid md:grid-cols-2 md:gap-x-4 mx-auto ' >
            ...
            <div className='text-invert flex flex-col border-b-[1px] border-invert mt-2 pb-5' >
                ...
                <span className='text-sm font-light text-gray-400' >Component styling</span>
                {/* <Line percent={75} className='rounded-full mt-2' strokeWidth={2} strokeColor="#219ebc" trailWidth={5} /> */}
            </div>
            <div className='text-invert flex flex-col border-b-[1px] border-invert mt-2 pb-5' >
                <span>Node js</span>
            ...
            <div className='text-invert flex flex-col border-b-[1px] border-invert mt-2 pb-5' >
                ...
                <span className='text-sm font-light text-gray-400' >State management</span>
                {/* <Line percent={70} className='rounded-full mt-2' strokeWidth={2} strokeColor="#219ebc" trailWidth={5} /> */}
            </div>
            <div className='text-invert flex flex-col border-b-[1px] border-invert mt-2 pb-5' >
                <span>Firebase</span>
                <span className='text-sm font-light text-gray-400' >NoSql database management</span>
                {/* <Line percent={75} className='rounded-full mt-2' strokeWidth={2} strokeColor="#219ebc" trailWidth={5} /> */}
            </div>
            <div className='text-invert flex flex-col border-b-[1px] border-invert mt-2 pb-5' >
                <span>mongoDb</span>
            ...
            <div className='text-invert flex flex-col border-b-[1px] border-invert mt-2 pb-5' >
                ...
                <span className='text-sm font-light text-gray-400' >version control</span>
                {/* <Line percent={75} className='rounded-full mt-2' strokeWidth={2} strokeColor="#219ebc" trailWidth={5} /> */}
            </div>
            <div className='text-invert flex flex-col border-b-[1px] border-invert mt-2 pb-5' >
                <span>Agile development methodology</span>
                <span className='text-sm font-light text-gray-400' >Development methodology</span>
                {/* <Line percent={70} className='rounded-full mt-2' strokeWidth={2} strokeColor="#219ebc" trailWidth={5} /> */}
            </div>
        </div>
    </div>
