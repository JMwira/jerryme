  ...
  return (
    <div className='w-[85%] flex flex-col mx-auto justify-center items-center' >
      ...
      <div className='text-gray-400 w-full flex flex-col gap-x-2 pt-8 items-start' >
        ...
        <div className='flex-1 mx-auto w-[70%] text-center' >
            ...
            <div className='flex flex-col gap-y-2 mt-5 text-sm font-light' >
                <input className='text-center py-2 bg-transparent border-b-[1px] px-2' placeholder='email' />
                <textarea className='text-center py-2 bg-transparent border-b-[1px] px-2 min-h-[100px] max-h-[100px]' placeholder='enter your message here' />
                <button className='bg-invert p-2 px-10 text-primary rounded-full w-[200px] mx-auto mt-5' >Send</button>
            </div>
        </div>
        <div className='flex mx-auto pb-6 flex-row gap-x-8 mt-5 font-light' >
